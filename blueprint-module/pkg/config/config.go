...
type OAuthConfig struct {
	...
	LinkedIn LinkedInOAuthConfig `json:"linkedin"`
	Twitter  TwitterOAuthConfig  `json:"twitter"`
	...
	return &Config{
		...
		OAuth: OAuthConfig{
			...
			LinkedIn: LinkedInOAuthConfig{
				...
				Scopes:       getEnv("LINKEDIN_SCOPES", "r_liteprofile r_emailaddress"),
			},
