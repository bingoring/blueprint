...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (isDark) {
      ...
      root.style.setProperty("--bg-card", "#141922");
      root.style.setProperty("--bg-hover", "#1f2329");
      ...
      root.style.setProperty("--primary-color-light", "rgba(24, 144, 255, 0.1)");
      root.style.setProperty("--color-success", "#00d395");
      root.style.setProperty("--color-error", "#ff4d6d");
